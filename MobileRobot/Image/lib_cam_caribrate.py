...
def caribrate(path,save=False):
    ...
    if save:
        # files = glob.glob("/home/pat/HG_internship/MobileRobot/camera.yml")
        save_coefficients(DIM,K,D,"/home/pat/HG_internship/MobileRobot/camera.yml")
...
if __name__ == "__main__":
    ...
    caribrate("/home/pat/HG_internship/MobileRobot/video/006/*.png",save=True)